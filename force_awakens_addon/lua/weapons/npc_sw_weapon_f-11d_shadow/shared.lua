...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "NPC_F-11D Shadow"			
	SWEP.Author				= "spartanmark6"
	SWEP.ViewModelFOV		= 60
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("HUD/killicons/sw")
	
	killicon.Add( "npc_sw_weapon_f-11d_shadow", "HUD/killicons/f11_icon", Color( 255, 80, 0, 255 ) )

end

SWEP.HoldType				= "ar2"
SWEP.Base					= "weapon_swtfa_base"
...
SWEP.ViewModel				= ""
SWEP.WorldModel				= "models/weapons/w_F-11D_Shadow.mdl"

SWEP.Weight					= 5
SWEP.AutoSwitchTo			= false
SWEP.AutoSwitchFrom			= false

local FireSound 			= Sound ("weapons/starwars/f-11d_fire.wav");
local ReloadSound			= Sound ("weapons/starwars/f11_reload.wav");
