...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "NPC_F-11D Phasma"			
	...
	killicon.Add( "npc_sw_weapon_f-11d", "HUD/killicons/f11_icon", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= ""
SWEP.WorldModel				= "models/weapons/w_F-11D_Phasma.mdl"
